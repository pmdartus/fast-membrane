const { default: SymbolMembrane } = require('../src/symbol/main');
const { default: WeakMapMembrane } = require('../src/weakmap/main');

function testMembrane(membraneType, Membrane) {
    ...
    describe(membraneType, () => {
        ...
        describe('Complex properties access', () => {
            ...
            it(`should not throw when accessing a property non-configurable and non-writable`, () => {
                const membrane = new Membrane();
...
testMembrane('SymbolMembrane', SymbolMembrane);
testMembrane('WeakMapMembrane', WeakMapMembrane);